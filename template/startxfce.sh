# This script is basically the same startxfce-script used by the native OOD
...
echo DISPLAY IS $DISPLAY >> "$XFCE_LOG_FILE"
rdisplay="$(echo $DISPLAY | sed s'/alvis1//')"
echo rdisplay IS $rdisplay >> "$XFCE_LOG_FILE"
xfce4-session --display="$rdisplay"
